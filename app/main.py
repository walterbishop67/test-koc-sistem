...
from app.infrastructure.shared.logger import get_logger, setup_logging, trace_step
from app.infrastructure.supabase.client import close_client, init_client
...
def create_app() -> FastAPI:
    ...
    # ── Router kaydı ─────────────────────────────────────────────────────────
    from app.services.auth_services.routes.auth_routes import router as auth_router
    from app.services.auth_services.routes.users_routes import router as users_router
    from app.services.board_services.routes.board_routes import router as board_router
    from app.services.card_services.routes.card_routes import router as card_router
    from app.services.column_services.routes.column_routes import router as column_router
    from app.services.comment_services.routes.comment_routes import router as comment_router
    from app.services.notification_services.routes.notification_routes import router as notification_router
    from app.services.sprint_services.routes.sprint_routes import router as sprint_router
    from app.services.ai_services.routes.ai_routes import router as ai_router
    from app.services.label_services.routes.label_routes import router as label_router
    from app.services.team_services.routes.team_routes import router as team_router
