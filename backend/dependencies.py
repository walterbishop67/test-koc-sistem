...
from backend.infrastructure.auth.jwt import AuthenticatedUser, fetch_supabase_user
...
async def get_board_controller(request: Request):
    from backend.services.board_services.controllers.board_controller import BoardController
    from backend.services.board_services.repository.board_repository import BoardRepository
    from backend.services.board_services.services.board_service import BoardService
...
async def get_column_controller(request: Request):
    from backend.services.board_services.repository.board_repository import BoardRepository
    from backend.services.column_services.controllers.column_controller import ColumnController
    from backend.services.column_services.repository.column_repository import ColumnRepository
    from backend.services.column_services.services.column_service import ColumnService
...
async def get_team_controller(request: Request):
    from backend.services.notification_services.repository.notification_repository import NotificationRepository
    from backend.services.team_services.controllers.team_controller import TeamController
    from backend.services.team_services.repository.team_repository import TeamRepository
    from backend.services.team_services.services.team_service import TeamService
...
async def get_card_controller(request: Request):
    ...
    from backend.services.card_services.repository.activity_repository import ActivityRepository
    from backend.services.card_services.repository.card_repository import CardRepository
...
async def get_label_controller(request: Request):
    from backend.services.label_services.controllers.label_controller import LabelController
    from backend.services.label_services.repository.label_repository import LabelRepository
